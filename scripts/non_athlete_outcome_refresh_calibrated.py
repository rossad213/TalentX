#!/usr/bin/env python3
"""Run Music/Actor outcome refresh with market-wide breakout calibration v2."""
from __future__ import annotations

import non_athlete_outcome_refresh as base
...
base.chart_target = music_chart_target
base.actor_box_office_target = actor_box_office_target
